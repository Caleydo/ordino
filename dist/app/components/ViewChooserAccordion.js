...
export function ViewChooserAccordion(props) {
    ...
    return React.createElement("div", { className: "view-buttons flex-grow-1 flex-row border-top border-light" }, Object.keys(groups).map((v, i) => (React.createElement("div", { className: `accordion-item ${i < Object.keys(groups).length ? 'border-0 border-bottom border-light' : ''}`, key: i },

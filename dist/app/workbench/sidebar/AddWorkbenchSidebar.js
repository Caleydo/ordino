            ...
            return (React.createElement("div", { className: 'entityJumpBox p-1 mb-2 rounded' },
                ...
                availableViews.filter((v) => v.v.itemIDType === e).map((v) => {
                    ...
                    return (React.createElement("div", null,
                        ...
                        v.v.relation.mapping.map((map) => {
                            const columns = v.v.isSourceToTarget ? map.sourceToTargetColumns : map.targetToSourceColumns;
                            return (React.createElement(React.Fragment, null,
                                React.createElement("div", null, map.name),
                                columns.map((col) => {
                                    return (React.createElement("div", { className: "form-check" },
                                        React.createElement("input", { onChange: () => relationListCallback({ targetEntity: e, mappingEntity: map.entity, mappingSubtype: col.columnName }), className: "form-check-input", type: "checkbox", value: "", id: "flexCheckDefault" }),

...
export function HeaderNavigation({ fixed, bg = 'dark' }) {
    ...
    return (React.createElement("nav", { className: `ordino-header-navigation navbar navbar-expand-lg navbar-dark bg-${bg} ${fixed === 'top' ? 'fixed-top' : ''} ${fixed === 'bottom' ? 'fixed-bottom' : ''}` },
        React.createElement("div", { className: "container-fluid" },
            ...
            React.createElement("div", { className: "order-1 navbar-collapse collapse", id: "ordino-header-navbar-nav" }, links && (React.createElement("ul", { className: "navbar-nav" }, links.map(({ text, page, faIcon }, i) => (React.createElement("li", { className: "px-3 nav-item", key: i },

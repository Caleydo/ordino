 ...
 */
export async function createViewImpl(inputs, parameter, graph) {
 ...
 * @returns {ICmdResult}
 */
export function removeViewImpl(inputs, parameter) {
    const app = inputs[0].value;
 ...
 * @returns {Promise<ICmdResult>}
 */
export async function replaceViewImpl(inputs, parameter) {
    const app = inputs[0].value;
 ...
 * @returns {IAction}
 */
export function createView(app, viewId, idtype, selection, options, itemSelection) {
    const view = PluginRegistry.getInstance().getPlugin(EXTENSION_POINT_TDP_VIEW, viewId);
    // assert view
 ...
 * @returns {IAction}
 */
export function removeView(app, view, oldFocus = -1) {
    // assert view
 ...
 * @returns {IAction}
 */
export function replaceView(app, existingView, viewId, idtype, selection, options, itemSelection) {
    const view = PluginRegistry.getInstance().getPlugin(EXTENSION_POINT_TDP_VIEW, viewId);
    // assert view
...
export async function setSelectionImpl(inputs, parameter) {
...
export function setSelection(view, idtype, range) {
    // assert view
...
export function setAndUpdateSelection(view, target, idtype, range) {
    // assert view
 ...
 * @returns {Array}
 */
export function compressCreateRemove(path) {
    const r = [];
...
export function compressSetSelection(path) {

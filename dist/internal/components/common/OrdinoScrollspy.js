...
export function OrdinoScrollspy(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "ordino-scrollspy-container px-0 px-xxl-15" }, props.children(handleOnChange)),
        React.createElement("ul", { className: "list-group d-none d-xxl-block list-group-flush ordino-scrollspy-nav flex-column ml-4" }, props.items.map((item) => {

 ...
 */
export function CommonSessionCard({ cardName, faIcon, cardInfo, children, highlight }) {
    ...
    return React.createElement(React.Fragment, null,
        React.createElement("h4", { className: "text-left d-flex align-items-center mb-3" },
            ...
            cardName),
        React.createElement(Card, { ref: parent, className: `session-card ${highlight && 'highlight-card'}` },

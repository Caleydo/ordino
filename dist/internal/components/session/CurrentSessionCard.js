...
export default function CurrentSessionCard({ name, faIcon }) {
    ...
    return (React.createElement(CommonSessionCard, { cardName: name, highlight: highlight, onHighlightAnimationEnd: onHighlightAnimationEnd, faIcon: faIcon, cardInfo: I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.currentCardInfo') }, (sessionAction) => {
        ...
        return React.createElement(SessionListItem, { desc: desc, selectSession: (event) => sessionAction("select" /* SELECT */, event, desc) },
            React.createElement("button", { type: "button", className: "mr-2 pt-1 pb-1 btn btn-outline-secondary", title: disabled ? I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.alreadySaved') : I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.saveSession'), disabled: disabled, onClick: (event) => sessionAction("save" /* SAVE */, event, desc) }, I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.save')),
            React.createElement(ListItemDropdown, null,
                React.createElement("button", { className: "dropdown-item", title: I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.editDetails'), onClick: (event) => sessionAction("clone" /* CLONE */, event, desc) }, I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.edit')),

import { I18nextManager, UserSession, UniqueIdManager } from 'tdp_core';
            ...
            return React.createElement(React.Fragment, null,
                React.createElement("ul", { className: "nav nav-pills session-tab card-header-pills", role: "tablist" },
                    React.createElement("li", { className: "nav-item", role: "presentation" },
                        React.createElement("a", { className: "nav-link active", "data-testid": "my-sessions-link", id: `saved-session-tab-${id}`, "data-bs-toggle": "tab", href: `#saved-session-mine-panel-${id}`, role: "tab", "aria-controls": `saved-session-mine-panel-${id}`, "aria-selected": "true" },
                            React.createElement("i", { className: "me-2 fas fa-user" }),
                            I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.mySessions'))),
                    React.createElement("li", { className: "nav-item", role: "presentation" },
                        React.createElement("a", { className: "nav-link", "data-testid": "other-sessions-link", id: `saved-session-other-tab-${id}`, "data-bs-toggle": "tab", href: `#saved-session-other-panel-${id}`, role: "tab", "aria-controls": `saved-session-other-panel-${id}`, "aria-selected": "false" },
                ...
                React.createElement("div", { className: "row pt-4" },
                    React.createElement("div", { className: "col" },
                        React.createElement("div", { className: "tab-content position-relative" },
                            React.createElement("div", { className: "tab-pane fade show active ordino-session-list p-1", "data-testid": "my-sessions", role: "tabpanel", id: `saved-session-mine-panel-${id}`, "aria-labelledby": `saved-session-mine-tab-${id}` },
                                status === 'pending' &&
                            ...
                            React.createElement("div", { className: "tab-pane fade ordino-session-list p-1", "data-testid": "other-sessions", role: "tabpanel", id: `saved-session-other-panel-${id}`, "aria-labelledby": `saved-session-other-tab-${id}` },
                                status === 'pending' &&
                                    React.createElement("p", null,
                                        React.createElement("i", { className: "fas fa-circle-notch fa-spin" }),
                                        " ",
                                ...
                                status === 'success' && otherSessions.length > 0 && (otherSessions === null || otherSessions === void 0 ? void 0 : otherSessions.map((session) => {
                                    return React.createElement(SessionListItem, { key: session.id, desc: session },
                                        React.createElement("button", { type: "button", "data-testid": "clone-button", title: I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.cloneToTemporary'), onClick: (event) => sessionAction("clone" /* CLONE */, event, session), className: "me-2 pt-1 pb-1 btn btn-outline-secondary" }, "Clone"));
                                })),
                                status === 'error' && React.createElement("p", null, I18nextManager.getInstance().i18n.t('tdp:ordino.startMenu.loadingError')))))));
        })));
}

    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Card, { className: "shadow-sm" },
            React.createElement(Card.Body, { className: "p-3" },
                ...
                tempSessions.map((tempSession) => React.createElement(TemporarySessionListItem, { key: tempSession.id, status: status, value: tempSession, error: error, saveSession: saveSession, cloneSession: cloneSession, deleteSession: deleteSession }))))));
}

...
export const AnalysisSessionsTab = () => {
    return (React.createElement(Container, { className: "mb-4 mt-4 analysis-tab" },
        React.createElement(Row, null,
            React.createElement(Col, { md: 3 },
                React.createElement(Nav, { style: { position: 'fixed' }, className: "flex-column" },
                    React.createElement(Nav.Link, { className: `pl-5`, onClick: (evt) => null }, " Current Session"),
                    React.createElement(Nav.Link, { className: `pl-5`, onClick: (evt) => null }, " Saved Session"),
                    React.createElement(Nav.Link, { className: `pl-5`, onClick: (evt) => null }, " Temporary Session"),
                    React.createElement(Nav.Link, { className: `pl-5`, onClick: (evt) => null }, " Import Session"))),
...
//# sourceMappingURL=AnalysisSessionsTab.js.map
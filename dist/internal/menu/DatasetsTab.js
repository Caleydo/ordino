...
export function DatasetsTab() {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Nav, { className: "scrollspy-nav flex-column ml-4" },
            ...
            React.createElement(Link, { className: "nav-link", role: "button", to: `celllines_${suffix}`, spy: true, smooth: true, offset: -250, duration: 500 }, "Cell Lines"),
            React.createElement(Link, { className: "nav-link", role: "button", to: `tissues_${suffix}`, spy: true, smooth: true, offset: -250, duration: 500 }, "Tissues"),

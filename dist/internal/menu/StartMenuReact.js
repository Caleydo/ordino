...
export function StartMenuComponent({ header, app, options, modePromise }) {
    ...
    const { enableDatasetsTab, enableToursTab, enableSessionsTab, enableMoreTab } = BaseUtils.mixin(defaultConfig, options.clientConfig || {});

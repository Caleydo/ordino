 ...
 *
 */
export declare type ActionType = 'Ephemeral' | 'Regular';
/**
 *
 ...
 *
 */
export declare type ActionSaveStateMode = 'Complete' | 'Diff';
/**
 ...
 */
export declare type ActionFunction<T, Args extends any[]> = (state: T, ...args: Args) => void;
export declare type ActionReturnType<T, S> = {
    state: T;
    label: string;
...
export declare type ApplyObject<T, S> = {
    apply: (state: T, label?: string) => ActionReturnType<T, S>;
};
export declare type ActionObject<T, S, Args extends any[]> = {
    /**

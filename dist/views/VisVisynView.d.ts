...
export declare function VisVisynView({ data, columnDesc, selection, filteredOutIds, parameters, onSelectionChanged, onParametersChanged }: VisViewPluginType['props']): JSX.Element;

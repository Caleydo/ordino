...
export function VisynLoginForm({ onLogin }) {
    ...
    return (React.createElement("form", { className: "form-signin", action: "/login", method: "post", onSubmit: onSubmit },
        ...
        React.createElement("div", { className: "mb-3" },
            React.createElement("div", { className: "checkbox form-check" },
                React.createElement("input", { type: "checkbox", className: "form-check-input", id: "login_remember" }),
                React.createElement("label", { className: "form-label form-check-label", htmlFor: "login_remember" },
                    "$",

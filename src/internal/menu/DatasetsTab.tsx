    ...
    return (
        <>
            ...
            <Nav className="scrollspy-nav flex-column ml-4">
                ...
                <Link className="nav-link" role="button" to={`celllines_${suffix}`} spy={true} smooth={true} offset={-250} duration={500}>Cell Lines</Link>
                <Link className="nav-link" role="button" to={`tissues_${suffix}`} spy={true} smooth={true} offset={-250} duration={500}>Tissues</Link>

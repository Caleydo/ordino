...
import {IOrdinoOptions, Ordino, OrdinoApp} from '../..';
...
export function StartMenuComponent({header, app, options, modePromise}: {header: AppHeader, app: OrdinoApp, options: IOrdinoOptions, modePromise: Promise<StartMenuMode>}) {

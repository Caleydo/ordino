...
import { AppContext, LoginUtils, useAsync, useAsyncStatus, UserSession } from 'tdp_core';
 ...
 *
 */
export function useAutoLogin(): { loggedIn: boolean; userName: string; status: useAsyncStatus } {
